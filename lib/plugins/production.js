const isVendorModule = resource => {
  ...
  let belongsToBower = resource.indexOf(File.absPaths('bower_components')) === 0;
...
let productionPlugins = [
  ...
  new webpack.optimize.UglifyJsPlugin(Object.assign(config.scripts.options, {sourceMap: config.scripts.sourceMap})),
