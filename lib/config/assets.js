const ASSET_CONFIG = {
  ...
  mainDir: 'public', // The `public` directory contains the front controller and your assets (images, JavaScript, CSS, etc.)
  subDir: '', // Public subdirectory
  buildDir: 'build', // For dynamic language project
  options: {
