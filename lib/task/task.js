class Task {
  constructor(name) {
    ...
    switch (name) {
      case 'html':
        this.publicCssPath = config.html.replacement.begin + config.paths.target.css + config.html.replacement.end;
        this.publicJsPath = config.html.replacement.begin + config.paths.target.js + config.html.replacement.end;
        this.publicImgPath = config.html.replacement.begin + config.paths.target.img + config.html.replacement.end;
        break;
      case 'styles':
        this.publicFontPath = config.html.replacement.begin + config.paths.target.font + config.html.replacement.end;
      ...
      case 'version':
        ...
        this.publicCssPath = path.join(config.assets.subDir, config.paths.target.css) + '/';
        this.publicJsPath = path.join(config.assets.subDir, config.paths.target.js) + '/';
        this.publicImgPath = path.join(config.assets.subDir, config.paths.target.img) + '/';
        this.publicFontPath = path.join(config.assets.subDir, config.paths.target.font) + '/';
        break;
      default:
        this.dist = '';
    }
