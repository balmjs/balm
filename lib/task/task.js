class Task {
  constructor(name) {
    ...
    switch (name) {
      ...
      case 'css':
        this.input = [
          path.join(config.roots.source, config.paths.source.css, '**/*.css'),
          '!' + path.join(config.roots.source, config.paths.source.css, '**/_*.css')
        ];
      ...
      case 'less':
        this.input = [
          path.join(config.roots.source, config.paths.source.css, '**/*.less'),
          '!' + path.join(config.roots.source, config.paths.source.css, '**/_*.less')
        ];
        this.output = config.tmp.css;
        break;
        // scripts
