import {isString, mergeDeep, assetsPath, ASYNC_FOLDER} from './helper';
...
const webpackConfig = (input = '', output = '') => {
  ...
  let defaultConfiguration = {
    ...
    output: {
      ...
      chunkFilename: input
        ? jsChunkFilename
        : assetsPath(`${jsFolder}/${ASYNC_FOLDER}/${jsChunkFilename}`)
    },
    module: {
  ...
  // logger.success('Webpack configuration', configuration);
