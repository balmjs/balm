const DEFAULTS = {
  ...
  html: {
    regex: { // TODO: rename `regex`
      css: 'css', // The same to `paths.target.css`
      js: 'js', // The same to `paths.target.js`
  ...
  assets: {
    ...
    publicUrl: '', // Replace `%PUBLIC_URL%/` in html templates (the same to `scripts.extends.publicPath`)
