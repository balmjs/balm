...
var SassTask = /** @class */ (function (_super) {
    __extends(SassTask, _super);
    function SassTask() {
        return _super.call(this, 'sass') || this;
    }
    Object.defineProperty(SassTask.prototype, "options", {
        get: function () {
    ...
    SassTask.prototype.recipe = function (input, output, options) {
        var _this = this;
    ...
    Object.defineProperty(SassTask.prototype, "fn", {
        get: function () {
            return this.recipe();
        },
        enumerable: true,
