...
var RemoveTask = /** @class */ (function (_super) {
    __extends(RemoveTask, _super);
    function RemoveTask() {
        return _super.call(this, 'remove') || this;
    }
    RemoveTask.prototype.recipe = function (input) {
        var _this = this;
        return function (cb) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.init(input);
                        canDel = (BalmJS.utils.isString(this.input) && this.input.trim()) ||
                            (BalmJS.utils.isArray(this.input) && this.input.length);
                        if (!canDel) return [3 /*break*/, 2];
                        files = BalmJS.file.absPaths(this.input);
                        ...
                        return [4 /*yield*/, del_1.default(files, { force: true })];
                    case 1:
    ...
    RemoveTask.prototype.fn = function (cb) {
        cb();
    };
    return RemoveTask;
}(BalmJS.BalmTask));
