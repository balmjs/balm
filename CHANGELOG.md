...
> :tada: [`balm-core`](https://github.com/balmjs/balm/tree/main)(v4) supports for `node@12+`, `sass@latest`, `postcss@8`, `webpack@5`
...
- update config `styles.entry: string | string[]`

## v3.23.4 / 2022-05-11

### Chore

- update dependencies for `postcss@7`

## v3.23.3 / 2022-04-30

### Chore

- revert and test sass plugin with svg
